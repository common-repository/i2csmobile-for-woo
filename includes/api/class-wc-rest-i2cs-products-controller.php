 ...
 */
class WC_I2cs_REST_Products_Controller extends WC_I2cs_REST_Posts_Controller {
	...
	public function query_args( $args, $request ) {
		...
		if(isset($request['featured']) && $request['featured'] == true){
		...
		if(isset($request['sale']) && $request['sale'] == true){
